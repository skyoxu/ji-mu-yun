...
def build_parser() -> argparse.ArgumentParser:
    ...
    p_proto.add_argument("--prototype-type-kit-game-type", default="")
    p_proto.add_argument("--prototype-type-kit-path", default="")
    p_proto.add_argument("--prototype-type-kit-manifest-path", default="")
    p_proto.add_argument("--prototype-type-kit-gameplay-flow", action="append", default=[])
    p_proto.add_argument("--prototype-type-kit-scene-ui", action="append", default=[])
    p_proto.add_argument("--implementation-skill-name", default="")
    p_proto.add_argument("--implementation-skill-path", default="")
    p_proto.add_argument("--implementation-skill-contract-path", default="")
